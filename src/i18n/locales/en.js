const locale = {
  settings: {
    ...
    todayBtnComplete: "Show Complete button (\u2713)",
    todayBtnCompleteDesc: "Show the complete button on each task row",
    todayBtnSnooze1: "Show Snooze +1d button (\u23F1)",
    todayBtnSnooze1Desc: "Show the snooze +1 day button on each task row",
    todayBtnSnooze7: "Show Snooze +7d button (\u23F1+7)",
    todayBtnSnooze7Desc: "Show the snooze +7 days button on each task row",
    todayBtnCopyRef: "Show Copy Ref button (())",
    todayBtnCopyRefDesc: "Show a button to copy the block reference to the clipboard",
    todayBtnSidebar: "Show Open Sidebar button (\u29C9)",
    todayBtnSidebarDesc: "Show a button to open the task in the right sidebar",
    ...
    advancedDashboard: "Show advanced options",
    advancedDashboardDescription: "Reveal settings for review steps, keyboard shortcuts, queries and pills, suggestion rules, activity-log detail, picklists, AI capture, and attribute names. The defaults suit most users.",
    reviewStepsShow: "Review steps (Daily, Weekly, Monthly)",
    reviewStepsShowDescription: "Show the per-step toggles for each review flow. All steps are enabled by default.",
    suggestionRulesShow: "Suggestion rules",
    suggestionRulesShowDescription: "Show the per-rule toggles and the snooze threshold for Smart Suggestions.",
    ...
    suggestionsEnabledDescription: "Show suggestions in the dashboard based on snoozing patterns, weekday habits, and workload. Changes are made only with your confirmation.",
    suggestSnoozeThreshold: "Suggestion: snooze threshold",
    suggestSnoozeThresholdDescription: "Number of snoozes before suggesting that a task be moved to Someday/Maybe.",
    ...
    suggestRuleAdherence: "Suggestion rule: recurring-task adherence",
  ...
  today: {
    ...
    untitled: "(Untitled)",
    snoozeWeek: "Snooze +7d",
    copyRef: "Copy block reference",
    copyRefDone: "Block reference copied",
